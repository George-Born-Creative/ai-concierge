...
const styles = StyleSheet.create({
  ...
  label: { fontSize: UiTypography.label.fontSize, color: '#5B6B82', lineHeight: UiTypography.label.lineHeight, marginTop: UiSpacing.md, marginBottom: UiSpacing.xs },
  input: {
    borderWidth: 1,
    borderColor: '#E5EAF5',
  ...
  multiline: { minHeight: UiControlHeights.shortTextarea, paddingVertical: UiSpacing.sm, textAlignVertical: 'top' },
  androidPickerRow: { flexDirection: 'row', gap: UiSpacing.sm },
  androidPickerBtn: {
    alignItems: 'center',
    backgroundColor: '#F8FAFF',
    borderColor: '#E5EAF5',
  ...
  androidPickerBtnText: { fontSize: UiTypography.input.fontSize, color: '#0F172A', fontWeight: '500', lineHeight: UiTypography.input.lineHeight },
  offsetRow: { flexDirection: 'row', flexWrap: 'wrap', gap: UiSpacing.sm },
  chip: {
    justifyContent: 'center',
  ...
  chipText: { fontSize: UiTypography.button.fontSize, color: '#5B6B82', fontWeight: '500', lineHeight: UiTypography.button.lineHeight },
  chipTextActive: { color: 'white' },
  notifyHint: { fontSize: UiTypography.caption.fontSize, color: '#64748B', lineHeight: UiTypography.caption.lineHeight, marginTop: UiSpacing.sm },
  actions: { flexDirection: 'row', gap: UiSpacing.sm, marginTop: UiSpacing.xl },
  btn: { alignItems: 'center', borderRadius: UiRadii.control, flex: 1, justifyContent: 'center', minHeight: UiControlHeights.button },
